...
app.config['COGNITO_USER_POOL_ID'] = "us-east-1_cZEEJWjev"
app.config['COGNITO_CLIENT_ID'] = "3gq1ibpadf024u0vjj2vt0tci"
app.config['COGNITO_CLIENT_SECRET'] = "8vmm9tlibgiug5h9q9nj1u5daq1q4m0l7eo0v39ddi9guu1bfkr" # optional
app.config['COGNITO_DOMAIN'] = "https://testapp85.auth.us-east-1.amazoncognito.com"
app.config['COGNITO_REDIRECT_URI'] = "http://localhost:5000/callback"
app.config['COGNITO_SIGNOUT_URI'] = "http://localhost:5000/logout-redirect"
app.config['JWT_TOKEN_LOCATION'] = ('headers', 'cookies')
app.config['COGNITO_STATE'] = 'LOGIN'
